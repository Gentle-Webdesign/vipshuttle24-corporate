...
const Footer = () => {
  ...
  return (
    <>
      {/* WhatsApp Float – only on desktop to avoid overlap issues on mobile */}
      <a
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-silver/60 text-sm leading-relaxed">
                  ...
                  Sicherheit, Komfort und Eleganz in jedem Detail.
                </p>
              </div>
              <div className="flex space-x-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="VipShuttle24 auf Facebook"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="VipShuttle24 auf Instagram"
                  className="w-10 h-10 glass-card rounded-lg flex items-center justify-center hover:shadow-glow transition-all duration-300 group"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="VipShuttle24 auf WhatsApp kontaktieren"
                  className="w-10 h-10 glass-card rounded-lg flex items-center justify-center hover:shadow-glow transition-all duration-300 group"
                >
            ...
            <nav aria-label="Footer Navigation">
              <h3 className="text-silver font-display font-semibold mb-4 text-base lg:text-lg">Navigation</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item.href}>
                    <a
                      href={item.href}
                      className="text-silver/60 hover:text-silver transition-colors duration-300 text-sm"
                    >
                      {item.label}
                    </a>
                  </li>
            ...
            {/* Services */}
            <div>
              <h3 className="text-silver font-display font-semibold mb-4 text-base lg:text-lg">Services</h3>
            ...
            {/* Contact */}
            <div>
              <h3 className="text-silver font-display font-semibold mb-4 text-base lg:text-lg">Kontakt</h3>
              <address className="not-italic space-y-4">
                <a
                  ...
                  aria-label="Telefon: +49 177 2472408"
                >
                ...
                <a
                  ...
                  className="flex items-start space-x-3 text-silver/60 hover:text-silver transition-colors duration-300 group"
                  aria-label="E-Mail: info@vipshuttle24.de"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="flex items-start space-x-3 text-silver/60 hover:text-silver transition-colors duration-300 group"
                  aria-label="Adresse: Schlesische Str. 104, 40231 Düsseldorf"
                >
        ...
        <div className="border-t border-silver/10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-silver/50 text-xs sm:text-sm text-center sm:text-left">
                © {currentYear} VIPSHUTTLE24. Alle Rechte vorbehalten.
              </p>
              <nav aria-label="Rechtliches" className="flex space-x-5 text-sm">
                <a href="/impressum" className="text-silver/50 hover:text-silver transition-colors duration-300 text-xs sm:text-sm">
                  Impressum
                </a>
                <a href="/datenschutz" className="text-silver/50 hover:text-silver transition-colors duration-300 text-xs sm:text-sm">
                  Datenschutz
                </a>
                <a href="/agb" className="text-silver/50 hover:text-silver transition-colors duration-300 text-xs sm:text-sm">
                  AGB
                </a>
              </nav>
            </div>
